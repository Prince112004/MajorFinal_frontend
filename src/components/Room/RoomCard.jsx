...
const RoomCard = ({ assignment, onEdit, onDelete }) => {
  return (
    <div className="group relative bg-white dark:bg-slate-900 rounded-2xl p-5 border border-gray-200 dark:border-slate-800 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 w-full max-w-sm flex flex-col gap-5">
      ...
      <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700/50 mt-auto">
